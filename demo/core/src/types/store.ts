...
import type { SavedWallet, QueuedRequest, QueuedRequestData, RequestQueue, DisconnectNotification } from './wallet';
...
// Combined app state
export interface AppState extends WalletCoreSlice, WalletManagementSlice, TonConnectSlice, JettonsSlice, NftsSlice {
    auth: AuthState;
    isHydrated: boolean;
}

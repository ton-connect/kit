...
ton balance address UQ...     # TON balance for any address
...
ton jettons by-address UQ...  # Tokens for any address
ton jettons info EQCx...      # Jetton metadata
ton jettons wallet-address EQCx... UQ...  # Jetton wallet by owner
```
...
ton transactions status <normalizedHash>   # Tx status lookup
```
...
ton nft list-by-address UQ... # NFTs for any address

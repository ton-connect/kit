...
export class ApiClientToncenter extends BaseApiClient implements ApiClient {
    /** @param config - Toncenter v3 client config — endpoint URL, API key and optional DNS resolver override; defaults to mainnet/testnet Toncenter URLs based on `config.network`. */

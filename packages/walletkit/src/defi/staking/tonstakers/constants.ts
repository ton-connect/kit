...
export const DEFAULT_METADATA: Record<string, StakingProviderMetadata> = {
    [Network.mainnet().chainId]: {
        stakeTokenTicker: 'TON',
        stakeTokenDecimals: 9,
        stakeTokenAddress: 'ton',
        lstTicker: 'tsTON',
        lstDecimals: 9,
        lstAddress: 'EQC98_qAmNEptUtPc7W6xdHh_ZHrBUFpw5Ft_IzNU20QAJav' as UserFriendlyAddress,
    ...
    [Network.testnet().chainId]: {
        ...
        lstTicker: 'TUNA',
        lstDecimals: 9,
        lstAddress: 'kQAiQ2XK7BXePLwemeo-u4wNyjg-wxGeySmaFGEP7R2Mhf4m' as UserFriendlyAddress,

...
import type { EventDispatcher, ITonConnect, SdkActionEvent } from '@ton/appkit';
import type { TonConnectUiOptions } from 'src/models/ton-connect-ui-options';
import type { UserActionEvent } from 'src/tracker/types';

export type TonConnectUiCreateOptions = TonConnectUiOptionsWithConnector | TonConnectUiOptionsWithManifest;
...
export interface TonConnectUiOptionsWithConnector extends TonConnectUiCreateOptionsBase {
    /**
     * TonConnect instance. Can be helpful if you use custom ITonConnect implementation, or use both of @ton/appkit and @tonconnect/ui in your app.
     */

...
import type { ConnectAdditionalRequest, ITonConnect, WalletInfoCurrentlyEmbedded, WalletInfoRemote } from '@ton/appkit';
import { isWalletInfoCurrentlyEmbedded, isWalletInfoRemote } from '@ton/appkit';
...
import type { TonConnectUITracker } from 'src/tracker/ton-connect-ui-tracker';
...
interface SingleWalletModalManagerCreateOptions {
     ...
     */
    setConnectRequestParametersCallback: (callback: (parameters?: ConnectAdditionalRequest) => void) => void;

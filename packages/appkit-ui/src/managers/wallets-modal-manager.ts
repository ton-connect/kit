...
import { isConnectUrl, isWalletInfoCurrentlyEmbedded, UUIDv7 } from '@ton/appkit';
...
export class WalletsModalManager implements WalletsModal {
     ...
     * @internal
     */
    private connectEmbeddedWallet(embeddedWallet: WalletInfoCurrentlyEmbedded, options: Traceable): void {

...
import type { ConnectAdditionalRequest, WalletInfoInjectable, WalletInfoRemote } from '@ton/appkit';
import {
    isTelegramUrl,
...
import { createEffect, createSignal, Match, onCleanup, Show, Switch, untrack, useContext } from 'solid-js';
import { ConnectorContext } from 'src/app/state/connector.context';
import { BrowserIcon, Button, DesktopIcon, LinkIcon, LoaderIcon, MobileIcon, RetryIcon } from 'src/app/components';
...
import type { WalletsModalState } from 'src/models';
    ...
    return (
        <DesktopConnectionModalStyled data-tc-wallets-modal-connection-desktop="true">
                        ...
                        <Switch>
                            ...
                            <Match when={connectionErrored() === 'not-supported'}>
                                <BodyTextStyled
                                    ...
                                    translationValues={{ name: props.wallet.name }}
                                >
                                    {props.wallet.name} doesn’t support the requested action. Please connect another
                            ...
                            <Match when={connectionErrored() === 'wrong-network'}>
                                ...
                                >
                                    ...
                                    {props.wallet.name} and try again.
                                </BodyTextStyled>
                            </Match>
                        </Switch>
                        <ButtonsContainerStyled>
            ...
            <Show when={props.wallet.appName === AT_WALLET_APP_NAME}>
                <TgButtonStyled rightIcon={<TgImageStyled src={IMG.TG} />} scale="s" onClick={onClickTelegram}>
            ...
            <Show when={props.wallet.appName !== AT_WALLET_APP_NAME}>
                <BottomButtonsContainerStyled>
                    <Show when={mode() !== 'mobile' && supportsMobile(props.wallet)}>
                        <FooterButton appearance="secondary" leftIcon={<MobileIcon />} onClick={onClickMobile}>
                            <Translation translationKey="common.mobile">Mobile</Translation>
                        </FooterButton>
                    </Show>
                    <Show when={mode() !== 'extension' && supportsExtension(props.wallet)}>
                        <FooterButton appearance="secondary" leftIcon={<BrowserIcon />} onClick={onClickExtension}>
                            <Translation translationKey="common.browserExtension">Browser Extension</Translation>
                        </FooterButton>
                    </Show>
                    <Show when={mode() !== 'desktop' && supportsDesktop(props.wallet)}>
                        <FooterButton appearance="secondary" leftIcon={<DesktopIcon />} onClick={onClickDesktop}>

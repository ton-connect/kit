...
import { Button, PersonalityIcon, SecurityIcon, SwapIcon, WalletIcon, ScrollContainer, Link } from 'src/app/components';
...
export const InfoModal: Component<InfoModalProps> = (props) => {
    return (
        <InfoModalStyled data-tc-wallets-modal-info="true">
            ...
            <H1Styled translationKey="walletModal.infoModal.whatIsAWallet">What is a wallet</H1Styled>
            ...
            <ScrollContainer>
                ...
                <InfoBlock>
                    ...
                    <TextStyled translationKey="walletModal.infoModal.manageIdentity">
                        Manage your digital identity and access decentralized applications with ease. Maintain control
                        over your data and engage securely in the blockchain ecosystem.
                    </TextStyled>
                </InfoBlock>
                <InfoBlock>
                    ...
                    <TextStyled translationKey="walletModal.infoModal.easilySend">
                        Easily send, receive, monitor your cryptocurrencies. Streamline your operations with
                ...
                <ButtonsBlock>
                    <Link href={LINKS.GET_A_WALLET} blank>
                        <Button rightIcon={<WalletIcon />}>
                            <Translation translationKey="walletModal.infoModal.getAWallet">Get a Wallet</Translation>
                        </Button>
                    </Link>
                </ButtonsBlock>
            </ScrollContainer>

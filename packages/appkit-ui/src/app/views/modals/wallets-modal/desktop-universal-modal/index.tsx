...
export const DesktopUniversalModal: Component<DesktopUniversalModalProps> = (props) => {
    ...
    return (
        ...
        >
            <H1 translationKey="walletModal.desktopUniversalModal.connectYourWallet">Connect your wallet</H1>
            <H2Styled translationKey="walletModal.desktopUniversalModal.scan">Scan with your mobile wallet</H2Styled>
            <QRCodeStyled
            ...
            <WalletsContainerStyled>
                <For each={visibleWallets()}>
                    {(wallet) => (
                        <li>
                            <WalletLabeledItem wallet={wallet} onClick={() => props.onSelect(wallet)} />
                        </li>
                    )}
                </For>
                <FourWalletsItem

...
import type { Wallet } from '@ton/appkit';
import { checkRequiredWalletFeatures } from '@ton/appkit';
...
export const DesktopFeatureNotSupportModal: Component<DesktopFeatureNotSupportModalProps> = (props) => {
    ...
    const currentWalletVersionNotSupported = createMemo(() => {
        ...
        const requiredFeature = props.walletsModalState.requiredFeature;
        const requiredFeatures = requiredFeature ? { [requiredFeature.featureName]: requiredFeature.value } : {};
        ...
        <DesktopFeatureNotSupportModalStyled>
            <Switch>
                ...
                <Match when={currentWalletVersionNotSupported()}>
                    ...
                    >
                        Your current version of {currentWalletName()} or wallet contract type doesn't support the
                        required features. Please update it to continue.
                    </BodyTextStyled>

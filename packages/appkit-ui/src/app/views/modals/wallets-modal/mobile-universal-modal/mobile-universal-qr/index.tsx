...
export const MobileUniversalQR: Component<MobileUniversalQRProps> = (props) => {
    return (
        <>
            ...
            <H2Styled translationKey="walletModal.mobileUniversalModal.scan">Scan with your mobile wallet</H2Styled>
            <QrCodeWrapper>
                <QRCode imageUrl={IMG.TON} sourceUrl={addReturnStrategy(props.universalLink, 'none')} disableCopy />
            </QrCodeWrapper>
            <ButtonsWrapper>
                <ActionButton appearance="secondary" onClick={() => props.onOpenLink()}>
                    <Translation translationKey="walletModal.mobileUniversalModal.openLink">Open Link</Translation>
                </ActionButton>
                <ActionButton appearance="secondary" onClick={() => props.onCopy()}>
                    <Translation
                        translationKey={props.isCopiedShown !== undefined ? 'common.copied' : 'common.copyLink'}
                    >

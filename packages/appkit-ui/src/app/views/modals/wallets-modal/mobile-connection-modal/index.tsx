...
import type { ConnectAdditionalRequest, WalletInfoRemote } from '@ton/appkit';
import { isTelegramUrl, WalletWrongNetworkError, WalletMissingRequiredFeaturesError } from '@ton/appkit';
import type { Component } from 'solid-js';
import { createEffect, createMemo, createSignal, Match, onCleanup, Show, Switch, useContext } from 'solid-js';
...
export const MobileConnectionModal: Component<MobileConnectionProps> = (props) => {
    ...
    const [isCopiedShown, setIsCopiedShown] = createSignal<ReturnType<typeof setTimeout> | undefined>(undefined);
                        ...
                        <ButtonsContainerStyled>
                            <Switch>
                                ...
                                <Match when={connectionErrored() === 'connection-declined'}>
                                    ...
                                    <Button leftIcon={<QRIcon fill={theme.colors.accent} />} onClick={onOpenQR}>

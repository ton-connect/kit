...
import { CHAIN, toUserFriendlyAddress } from '@ton/appkit';
                ...
                <li>
                    <MenuButtonStyled onClick={() => onCopy()}>
                        ...
                        <Show when={!isCopiedShown()}>
                            <MenuItemText translationKey="button.dropdown.copy">Copy address</MenuItemText>
                        </Show>
                        <Show when={isCopiedShown()}>
                            <MenuItemText translationKey="button.dropdown.copied">Address copied!</MenuItemText>
                        </Show>
                    </MenuButtonStyled>
                </li>
                <li>
                    <MenuButtonStyled onClick={() => onDisconnect()}>
                        <DisconnectIcon />
                        <MenuItemText translationKey="button.dropdown.disconnect">Disconnect</MenuItemText>
                    </MenuButtonStyled>
                </li>
            </UlStyled>

...
import type { BorderRadiusConfig } from 'src/app/models/border-radius-config';
...
export const ModalFooterStyled = styled.div`
    ...
    border-radius: 0 0 ${(props) => borders[props.theme!.borderRadius]} ${(props) => borders[props.theme!.borderRadius]};
`;

...
import type { EventDispatcher, ResponseVersionEvent, Version, WithoutVersion } from '@ton/appkit';
import {
...
export class TonConnectUITracker {
    ...
    private async requestTonConnectSdkVersion(): Promise<string> {
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                await this.eventDispatcher.dispatchEvent('ton-connect-request-version', createRequestVersionEvent());
            } catch (e) {
                reject(e);
            }
        });
     ...
     * @param args
     */
    public trackWalletModalOpened(...args: WithoutVersion<Parameters<typeof createWalletModalOpenedEvent>>): void {
        try {
     ...
     * @param args
     */
    public trackSelectedWallet(...args: WithoutVersion<Parameters<typeof createSelectedWalletEvent>>): void {
        try {
     ...
     * @param args
     */
    public trackConnectionCompleted(...args: WithoutVersion<Parameters<typeof createConnectionCompletedEvent>>): void {
        try {
     ...
     * @param args
     */
    public trackConnectionError(...args: WithoutVersion<Parameters<typeof createConnectionErrorEvent>>): void {
        try {
     ...
     * @param args
     */
    public trackDisconnection(...args: WithoutVersion<Parameters<typeof createDisconnectionEvent>>): void {
        try {
     ...
     * @param args
     */
    public trackTransactionSigned(...args: WithoutVersion<Parameters<typeof createTransactionSignedEvent>>): void {
        try {
     ...
     * @param args
     */
    public trackDataSigned(...args: WithoutVersion<Parameters<typeof createDataSignedEvent>>): void {
        try {
     ...
     * @param args
     */
    public trackDataSigningFailed(...args: WithoutVersion<Parameters<typeof createDataSigningFailedEvent>>): void {
        try {

 ...
 * @param context - Diagnostic context for tracing.
 */
export async function createTransferTonTransaction(args: CreateTransferTonTransactionArgs, context?: CallContext) {
 ...
 * @param context - Diagnostic context for tracing.
 */
export async function getTransactionPreview(args: TransactionContentArgs, context?: CallContext) {
 ...
 * @param context - Diagnostic context for tracing.
 */
export async function handleNewTransaction(args: TransactionContentArgs, context?: CallContext) {
 ...
 * @param context - Diagnostic context for tracing.
 */
export async function sendTransaction(args: TransactionContentArgs, context?: CallContext) {
    ...
    const transactionContent =
        typeof args.transactionContent === 'string'
            ? args.transactionContent.trim()
            : String(args.transactionContent ?? '').trim();

...
import { Send, useSwapQuote, useNetwork, useAddress, useBuildSwapTransaction } from '@ton/appkit-react';
...
export const SwapButton: FC<SwapButtonProps> = ({ amount, direction, providerId }) => {
    ...
    return <Send request={handleBuildSwapTransaction} disabled={!quote || isLoading || isError} text={buttonText} />;
};

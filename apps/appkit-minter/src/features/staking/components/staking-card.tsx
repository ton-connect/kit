...
import { UnstakeMode, useAddress, useBalance, useStakedBalance, Input, Button } from '@ton/appkit-react';
    ...
    return (
        <Card title="Staking">
            <div className="flex flex-col gap-3">
                ...
                <Input size="s" error={amountInvalid}>
                    <Input.Header>
                        <Input.Title>Amount (optional)</Input.Title>
                    </Input.Header>
                    <Input.Field>
                        <Input.Input
                            id="staking-amount"
                    ...
                    {amountInvalid ? (
                        <Input.Caption>Enter a positive number or leave empty to use 1.</Input.Caption>
                    ) : null}
                </Input>
                    ...
                    <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
                        {UNSTAKE_MODE_OPTIONS.map(({ mode, label }) => (
                            <Button
                                ...
                                variant={unstakeMode === mode ? 'fill' : 'bezeled'}
                                size="s"
                                fullWidth
                            >
                                {label}
